...
public class EmployeeView {
	...
	public static String displayCustomerProfile(Scanner input) {
		System.out.println("******************************************************************************************************************************");
		...
		System.out.println("Please select from the following user options:");
		System.out.println("\tEnter '1' to search Customer by Email." );
	...
	public static String displayViewProfile(Scanner input) {
		...
		System.out.println("CALL CONTROLLER TO GET PROFILE DETAILS\n");
