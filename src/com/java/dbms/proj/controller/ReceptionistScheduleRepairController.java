...
public class ReceptionistScheduleRepairController {
	...
	public static void scheduleRepair(Scanner input) throws SQLException, ParseException {
		...
		Customer customer = ReceptionistScheduleServiceController.customer;
		Appointment appointment = ReceptionistScheduleServiceController.appointment;
		...
		if(!userInput.equals("8")) {
			...
			com.java.dbms.proj.views.ReceptionistView.displayScheduleRepair2(); //Display second page header
			...
			if(res > 0 )
			{
				System.out.println("\t Thank you! The appointment has been scheduled. \n-------------------------------------------------------------------------------------------------------------------------------------");
				...
				System.out.println("\t\t******The entered car details could not be found regsitered in customer's name. Please re-enter the car details registered with ACME.******\n\n");
